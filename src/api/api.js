...
let base = 'http://192.168.1.116:8083/wxmallPort/'
// let base = 'http://10.0.0.37:8080/wxmallPort/'
export const localHostUrl='http://192.168.1.116:8083/wxmallPort/'
...
export const rolesCreate = params => {
    return axios.post(`${base}RolesCreate.json`,qs.stringify(params),{emulateJSON:true}).then(responseFilter);
}
//角色添加获取数据
export const createRolesPost = params => {
    return axios.post(`${base}createRolesPost.json`,qs.stringify(params),{emulateJSON:true}).then(responseFilter);
}
//角色管理修改
export const editRolesPost = params =>{
    return axios.post(`${base}editRolesPost.json`,qs.stringify(params),{emulateJSON:true}).then(responseFilter);
}
//角色删除
export const deletRolesPost = params =>{
    return axios.post(`${base}deletRolesPost.json`,qs.stringify(params),{emulateJSON:true}).then(responseFilter);
}
//角色类型
export const roleType = params =>{
    return axios.post(`${base}roleType.json`,qs.stringify(params),{emulateJSON:true}).then(responseFilter);
}
//角色列表
...
export const editSaveTemp = params => {
    return axios.post(`${base}editSaveTemp.json`,qs.stringify(params),{emulateJSON:true}).then(responseFilter)
}
...
//获取餐厅列表
export const getOptionByCT = params => {
    return axios.post(`${base}getOptionByCT.json`,qs.stringify(params),{emulateJSON:true}).then(responseFilter)
}
